...
Display your Summits on the Air (SOTA) activation data beautifully — GPX maps, elevation charts, hiking stats, contact tables, and a contact map. No other plugins needed.
